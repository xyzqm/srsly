<script lang="ts">
  ...
  import { saveLevel, seedDemo, clearDeck } from '$lib/data.remote';

  // Settings tab. Level is read from prefs (props) and saved via remote command; seed/clear
  // are one-shot remote commands with no local state to track.
