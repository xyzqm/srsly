...
async function main() {
  ...
  await writeFile(formsPath, `// Auto-generated by scripts/build-esdict.mjs — DO NOT EDIT BY HAND.
...
export const ES_FORMS: Record<string, string> = ${JSON.stringify(Object.fromEntries(usableForms), null, 0)};
`);
  ...
  await writeFile(levelsPath, `// Auto-generated by scripts/build-esdict.mjs — DO NOT EDIT BY HAND.
...
export const CEFR_LEVELS: Record<number, string[]> = ${JSON.stringify(levels, null, 0)};
`);
  ...
  await writeFile(vocabPath, `// Auto-generated by scripts/build-esdict.mjs — DO NOT EDIT BY HAND.
...
export const CEFR_VOCAB: Record<string, { reading: string; meaning: string }> = ${JSON.stringify(vocab, null, 0)};
`);
