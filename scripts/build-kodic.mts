...
async function main() {
  ...
  await writeFile(levelsPath, `// Auto-generated by scripts/build-kodic.mts — DO NOT EDIT BY HAND.
...
export const TOPIK_LEVELS: Record<number, string[]> = ${JSON.stringify(levels)};
`);
  ...
  await writeFile(vocabPath, `// Auto-generated by scripts/build-kodic.mts — DO NOT EDIT BY HAND.
...
export const TOPIK_VOCAB: Record<string, { reading: string; meaning: string }> = ${JSON.stringify(vocab)};
`);
