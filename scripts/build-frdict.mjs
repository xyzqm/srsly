...
async function main() {
  ...
  await writeFile(formsPath, `// Auto-generated by scripts/build-frdict.mjs — DO NOT EDIT BY HAND.
...
export const FR_FORMS: Record<string, string> = ${JSON.stringify(Object.fromEntries(usableForms), null, 0)};
`);
  ...
  await writeFile(levelsPath, `// Auto-generated by scripts/build-frdict.mjs — DO NOT EDIT BY HAND.
...
export const FR_LEVELS: Record<number, string[]> = ${JSON.stringify(levels, null, 0)};
`);
  ...
  await writeFile(vocabPath, `// Auto-generated by scripts/build-frdict.mjs — DO NOT EDIT BY HAND.
...
export const FR_VOCAB: Record<string, { reading: string; meaning: string }> = ${JSON.stringify(vocab, null, 0)};
`);
