...
export const SET_HELP: Record<string, string> = {
  ...
  forgotten: 'Every word you have failed at least once, however long ago and however well you know it now. A history, not a shortlist.',
  weak:      `Your worst ${MIN_LAPSES}+ lapse words by failure RATE — missed 6 of 9 outranks missed 6 of 60. Capped at the top 8, so it is a shortlist you can act on rather than the whole history.`,
