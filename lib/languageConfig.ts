...
export interface LanguageConfig {
  ...
  levelPrefKey: 'hskLevel' | 'jlptLevel' | 'cefrLevel';
...
export const SUPPORTED_LANGUAGES: LanguageConfig[] = [ZH_CONFIG, JA_CONFIG, ES_CONFIG];
...
export function levelFor(
  ...
  prefs: { hskLevel?: number; jlptLevel?: number; cefrLevel?: number },
): number {
