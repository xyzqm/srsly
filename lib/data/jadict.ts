...
const DEINFLECT_RULES: Rule[] = [
  ...
  ['られた',         ['る']],
  ['られる',         ['る']],
  // Godan passive progressive (passive stem + れています etc.)
  ['われていました', ['う']], ['かれていました', ['く']], ['がれていました', ['ぐ']],
  ['されていました', ['す']], ['たれていました', ['つ']], ['なれていました', ['ぬ']],
  ['ばれていました', ['ぶ']], ['まれていました', ['む']],
  ['われています',   ['う']], ['かれています',   ['く']], ['がれています',   ['ぐ']],
  ['されています',   ['す']], ['たれています',   ['つ']], ['なれています',   ['ぬ']],
  ['ばれています',   ['ぶ']], ['まれています',   ['む']],
  ['われていた',     ['う']], ['かれていた',     ['く']], ['がれていた',     ['ぐ']],
  ['されていた',     ['す']], ['たれていた',     ['つ']], ['なれていた',     ['ぬ']],
  ['ばれていた',     ['ぶ']], ['まれていた',     ['む']],
  ['われている',     ['う']], ['かれている',     ['く']], ['がれている',     ['ぐ']],
  ['されている',     ['す']], ['たれている',     ['つ']], ['なれている',     ['ぬ']],
  ['ばれている',     ['ぶ']], ['まれている',     ['む']],
  // Godan passive (non-progressive)
  ['われました',     ['う']], ['かれました',     ['く']], ['がれました',     ['ぐ']],
  ['されました',     ['す']], ['たれました',     ['つ']], ['なれました',     ['ぬ']],
  ['ばれました',     ['ぶ']], ['まれました',     ['む']],
  ['われます',       ['う']], ['かれます',       ['く']], ['がれます',       ['ぐ']],
  ['されます',       ['す']], ['たれます',       ['つ']], ['なれます',       ['ぬ']],
  ['ばれます',       ['ぶ']], ['まれます',       ['む']],
  ['われた',         ['う']], ['かれた',         ['く']], ['がれた',         ['ぐ']],
  ['された',         ['す']], ['たれた',         ['つ']], ['なれた',         ['ぬ']],
  ['ばれた',         ['ぶ']], ['まれた',         ['む']],
  ...
  ['んでる', ['ぬ', 'ぶ', 'む']],
  ['てる',   ['る']],          // ichidan
  // Resultative/stative 〜てある (transitive verb + ある: a state left by a deliberate
  // action, e.g. 書いてある "is written") — same onbin stem alternations as 〜ている.
  ['ってありました', ['う', 'つ', 'る']],
  ['いてありました', ['く']],
  ['いでありました', ['ぐ']],
  ['してありました', ['す']],
