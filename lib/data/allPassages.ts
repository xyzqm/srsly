...
export const PASSAGES: PassageData[] = [
  ...
  ], HSK1_RAW, HSK1_FREE, HSK1_QUESTIONS, HSK1_FILL, 75),
  ...
  ], HSK2_RAW, HSK2_FREE, HSK2_QUESTIONS, HSK2_FILL, 95),

  buildPassage(3, '学中文', [
    { text: '学', pinyin: 'xué', meaning: 'to study · to learn' },
    { text: '中文', pinyin: 'zhōngwén', meaning: 'Chinese (language)' },
  ], HSK3_RAW, HSK3_FREE, HSK3_QUESTIONS, HSK3_FILL, 110),
  ...
  ], HSK4_RAW, HSK4_FREE, HSK4_QUESTIONS, HSK4_FILL, 120),
  ...
  ], HSK5_RAW, HSK5_FREE, HSK5_QUESTIONS, HSK5_FILL, 145),
  ...
  ], HSK6_RAW, HSK6_FREE, HSK6_QUESTIONS, HSK6_FILL, 185),
];
